...
import skimage
from networkDesignFS import cnnModelFS, cnnModelFS3, cnnModelFS_iter
import h5py
import os
...
def myInputFn(files,batchSize,epochs):
    ...
    features.set_shape((None,834,834,13))
    labels.set_shape((None,834,834))
...
def readSpecH5(specName):
    ...
    data = data[::2,::2,:]
    outputBurnmap = outputBurnmap[::2,::2]
...
if __name__ == "__main__":
    ...
    files = glob.glob(inDir+'run*.h5')
    modelDir = "../models/farsiteTest_iter"
    modelFnc = cnnModelFS
    batchSize = 8
    epochs = 1
    ...
    with tf.Session() as sess:
        ...
        for i in range(0,epochs):
            ...
            with tf.variable_scope("cnnModelFS3") as scope:
                ...
                #data, truth = readSpecH5(bytes(files[0],'utf-8'))
